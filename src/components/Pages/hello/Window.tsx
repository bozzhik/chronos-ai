...
export default function Window() {
  return (
    <section className="relative mx-auto flex grow flex-col justify-center -mt-10 min-h-[400px] max-w-8xl sm:max-w-none sm:w-full sm:mx-4 overflow-hidden rounded-2xl border-2 border-neutral-800/50 bg-gradient-to-br from-neutral-800/10 to-neutral-800/30 shadow-2xl shadow-black backdrop-blur-[6px]">
      ...
      <div className="flex flex-col items-center justify-between h-full gap-6 px-24 mt-10 sm:px-2 xl:mt-7 py-28 sm:py-14">
        <div className="flex flex-col items-center gap-3">
          ...
          <h1 className="font-semibold tracking-tighter text-center text-7xl sm:text-5xl">
            Ultra realistic <span className="duration-200 text-primary">AI</span> game
          </h1>
          <p className="text-xl sm:text-lg max-w-[50ch] sm:max-w-[25ch] font-medium tracking-tight text-center whitespace-pre-line text-neutral-400">Immerse yourself in an ultra-realistic AI-powered game where every decision shapes your escape from dynamic scenarios.</p>
        </div>
